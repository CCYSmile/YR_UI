...
@interface YRLaunchAdManager()<XHLaunchAdDelegate>

@end

@implementation YRLaunchAdManager

+(void)load{
    [self shareManager];
}

+(YRLaunchAdManager *)shareManager{
    static YRLaunchAdManager *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        instance = [[YRLaunchAdManager alloc] init];
    });
    return instance;
}
